...
Customer Portal: Allows users to register, browse movies, view details, and book tickets.

Admin Dashboard: Provides a secure interface for administrators to manage movies, showtimes, and screening halls.

Cloud Storage Integration: Movie posters are uploaded directly to Amazon S3 for scalable storage.

Secure Authentication: User passwords are encrypted using secure hashing algorithms.
